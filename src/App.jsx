...
function App() {
  ...
  if(bmi<1){
    ...
    imgsrc = 'https://t2.gstatic.com/images?q=tbn:ANd9GcTmFeEfCB3t2s8nD86ZsiPzxwBYomDyf5MGNUX7Vsl_A337fdYs'
    note = 'Eat nutritious foods that are high in calories .'
  }else if(bmi>=18.5 && bmi<24.9){
    imgsrc = 'https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRI6fwvAakuBp_SmhqZA5bCEueZLo6WBrM7E3m_WI-SjoZIR_n9'
  }else if(bmi>=25  && bmi<29.9){
    imgsrc= 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTino9AkquUaCPR4vFcWwaBoDIvfkzqXkaeNMz2vsoCj4aAruZe'
    note='Eat a healthy, reduced-calorie diet and exercise regularly. '
  }else{
    imgsrc = 'https://t2.gstatic.com/images?q=tbn:ANd9GcQxLokEKoNOxHJcApw4zl7MpTqntqnoXGBRsnwFaYwjfHjhWMxB'
    ...
    <>
     ...
     <h3  style={{alignItems:'center',marginLeft:'300px'}}>BMI Calculator</h3>
      ...
      <Col lg={6}>
        ...
        <p style={{paddingTop:'20px',paddingLeft:'50px',borderStyle:'hidden'}}>{note}</p><br />
      </Col>
     </Row>
